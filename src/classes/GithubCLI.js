    ...
    setVersion() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let fileContent = yield promises_1.default.readFile(this.filePath, 'utf8');
                fileContent = fileContent.replace(/version: '[^']*'/, `version: '${this.version}'`);
                yield promises_1.default.writeFile(this.filePath, fileContent);
            }
            catch (e) {
    ...
    pushChanges() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield exec.exec('git', ['push', '-f', 'origin', this.versionBranch]);
            }
            catch (e) {
